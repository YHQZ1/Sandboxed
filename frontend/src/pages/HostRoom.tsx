...
export default function HostRoom({ code, socket }: Props) {
  ...
  return (
    <div className="h-screen w-full bg-[#0a0a0a] text-[#ededed] font-sans flex flex-col overflow-hidden selection:bg-[#262626] selection:text-[#ededed]">
      <header className="flex items-center justify-between px-8 py-3 border-b border-[#262626] bg-[#0a0a0a] flex-shrink-0 z-10">
      ...
      <nav className="flex items-center gap-8 px-8 border-b border-[#262626] bg-[#0a0a0a] flex-shrink-0">
        {tabs.map((tab) => (
          <button
            key={tab.key}
            onClick={() => handleTabChange(tab.key)}
            className={`py-3.5 text-sm font-medium transition-colors relative flex items-center gap-2 ${
              activeTab === tab.key
                ? "text-[#ededed]"
      ...
      <main className="flex-1 flex overflow-hidden bg-[#0a0a0a]">
        {activeTab === "problems" && (
          <div className="flex-1 flex overflow-hidden w-full">
            <div className="w-80 border-r border-[#262626] bg-[#0a0a0a] flex flex-col flex-shrink-0">
              ...
              <div className="flex-1 overflow-y-auto p-2 flex flex-col gap-0.5">
                {problems.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center px-4">
                    <p className="text-sm text-[#737373]">No problems yet.</p>
                  </div>
                ) : (
                  problems.map((p, i) => (
                    <button
            ...
            <div className="flex-1 overflow-y-auto border-r border-[#262626] p-10 lg:p-14 bg-[#0a0a0a]">
              <div className="max-w-3xl mx-auto w-full h-full flex items-center justify-center">
                {selectedProblem ? (
                  ...
                  <p className="text-xl text-[#404040] tracking-wide">
            ...
            {selectedProblem && (
              <div className="w-80 lg:w-[400px] flex-shrink-0 bg-[#0a0a0a] p-8 flex flex-col gap-10">
                <section>
                  <h3 className="text-[10px] uppercase tracking-widest font-bold text-[#404040] mb-5">
                    Live Analytics
                  </h3>
